...
(use-package general
  :config
  (general-create-definer isp/leader-keys
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(js2-mode lsp-ivy lsp-treemacs lsp-ui which-key use-package rainbow-delimiters org-bullets monokai-theme lsp-mode ivy-rich hydra helpful general forge evil-magit evil-collection doom-themes doom-modeline counsel-projectile command-log-mode)))
(custom-set-faces
