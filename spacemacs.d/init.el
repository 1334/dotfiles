...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(;; ----------------------------------------------------------------
     ...
     dash
     docker
     (elixir :variables elixir-backend 'lsp elixir-ls-path "~/.elixir-ls/release")
     elm
     emacs-lisp
     erlang
     git
...
before packages are loaded."
  ...
  ;; fix for the linter https://github.com/syl20bnr/spacemacs/issues/10131
  (setq js2-mode-show-parse-errors nil js2-mode-show-strict-warnings nil)
  (eval-after-load 'js2-mode
    '(add-hook 'js2-mode-hook #'add-node-modules-path))

  ;; fix elixir format to make it work with asdf
  ...
  ;; set elixir source code for alchemist
  (setq alchemist-goto-elixir-source-dir "~/code/_source/elixir")
  (setq treemacs-sorting 'alphabetic-asc)

  (with-eval-after-load 'elixir-mode
    (spacemacs/declare-prefix-for-mode 'elixir-mode
      "t" "tests" "testing related functionality")
  ...
  ;; make phoenix live view templates use web-mode
  (add-to-list 'auto-mode-alist '("\\.leex\\'" . web-mode))

  ;; setup jest-test-mode
  (require 'jest-test-mode)
  (add-hook 'js2-mode-hook 'jest-test-mode)
  (setq jest-test-options '("--color" "--forceExit"))
  ...
  (dolist (mode '(js2-mode typescript-mode))
    (with-eval-after-load mode
      ...
      (spacemacs/set-leader-keys-for-major-mode mode
        "ta" 'jest-test-run-all-tests
        "tr" 'jest-test-rerun-test
        "tn" 'jest-test-run
        "tb" 'jest-test-run
        "tt" 'jest-test-run-at-point)
      (spacemacs/set-leader-keys-for-major-mode mode
        "ED" 'tide-add-eslint-disable-next-line
        "En" 'tide-next-error-function))
    )
